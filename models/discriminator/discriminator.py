...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = DiscBlock(in_channels=64, out_channels=64) # 64x64
        self.conv3 = DiscBlock(in_channels=64, out_channels=128) # 32x32
        ...
        self.fromrgb = nn.ModuleList([
            ...
            InpBlock(out_channels=64), # 32x32
            InpBlock(out_channels=64), # 64x64
